...
class SmartRouteOptimizer:
    ...
    def optimize(self, criteria: SearchCriteria) -> OptimizerResult:
        ...
        # Quick mode: skip transit searches — tampilkan hasil langsung saja.
        # Full mode (Refresh Harga): cari juga semua kombinasi transit.
        if not max_per_mode:
        ...
        if self.max_transits >= 2 and not max_per_mode:
